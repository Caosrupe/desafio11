...
const  additem=({productname},{itemid},{count},{itemprice})=>{setCarts([...carts,{itemid,productname,count,itemprice}]);}
...
const  cartlength=()=>{
    let sum,i; sum=0; i=0;
        ...
        if(carts.length){
            ...
            while(i<carts.length){sum=carts[i].count+sum;i++;
        }
...
const total=()=>{
    let sum,i;sum=0;i=0;
        ...
        if(carts.length){
            ...
            while(i<carts.length){sum= carts[i].count*carts[i].itemprice+sum;i++;
        }
            return sum;
        }
